...
const cloudflareClient: CloudflareClient = new CloudflareClient(testData.auth.email, testData.auth.key);

describe('Cloudflare Client', () => {
  it('should get the zone id of a domain', async() => {
    const record: IRecord = testData.records[0];
  ...
  it('should get record data for records', async() => {
    const records: Array<IRecord> = testData.records;
